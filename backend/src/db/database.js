...
const migrations = [
  ...
  `ALTER TABLE wa_mensagens ADD COLUMN media_url TEXT`,
  `ALTER TABLE wa_mensagens ADD COLUMN tipo TEXT NOT NULL DEFAULT 'texto'`,
  `ALTER TABLE wa_conversas ADD COLUMN telefone_real TEXT`,
